				...
				<div className="flex justify-between menuContainer">
					<div className="w-full lg:w-1/5 mb-6 lg:mb-0">
						...
						<ul>
							...
							<li>
								<a href="/#por-que" className="hover:underline">
									Por que Nosotros?
								</a>
							</li>
							<li>
							...
							<li>
								<a href="/#destacados" className="hover:underline">
					...
					<div className="w-full lg:w-1/5 mb-6 lg:mb-0">
						...
						<ul>
							<li>
								<a href="/nosotros#equipo" className="hover:underline">
									Nuestro Equipo
								</a>
							</li>
							<li>
								<a href="/nosotros/#empresa" className="hover:underline">
					...
					<div className="w-full lg:w-1/5 mb-6 lg:mb-0">
						...
						<ul>
							...
							<li>
								<a href="/productos/seguridad" className="hover:underline">
									Seguridad
								</a>
							</li>
							<li>
